...
test.describe.serial('Health Check', () => {
  ...
  test('AB-HC-02: 주요 페이지 응답 상태 (Shop, About, Pricing)', async ({ page }) => {
    albumbuddy = new AlbumBuddyPage(page);
...
test.describe('홈페이지', () => {
  ...
  test.describe('페이지 로드 및 기본 UI', () => {
    ...
    test('AB-PAGE-02: 네비게이션 버튼 표시 (About, Pricing, Dashboard, Request item)', async ({ page }) => {
      albumbuddy = new AlbumBuddyPage(page);
      await albumbuddy.gotoHome();
      await albumbuddy.verifyNavButtons();
    });

    test('AB-PAGE-03: 브랜드 요소 표시 (AlbumBuddy, MAKESTAR, USD)', async ({ page }) => {
      albumbuddy = new AlbumBuddyPage(page);
      await albumbuddy.gotoHome();
  ...
  test.describe('콘텐츠 섹션', () => {
    ...
    test('AB-PAGE-04: 핵심 섹션 확인 (Artists, Recent Albums, Trending, Official Partner)', async ({ page }) => {
      albumbuddy = new AlbumBuddyPage(page);
      await albumbuddy.gotoHome();
...
test.describe('상품 상세 및 Request Item', () => {
  ...
  test.describe('상품 상세 페이지', () => {
    ...
    test('AB-PAGE-08: 상품 상세 페이지 요소 확인 (이미지, 가격, 제목)', async ({ page }) => {
      albumbuddy = new AlbumBuddyPage(page);
      await albumbuddy.gotoHome();
...
test.describe('Dashboard', () => {
  ...
  test.describe('비로그인 인증 확인', () => {
    ...
    test('AB-AUTH-01: Dashboard 접근 시 로그인 요구', async ({ page }) => {
      albumbuddy = new AlbumBuddyPage(page);
      await albumbuddy.gotoHome();
    ...
    test('AB-AUTH-02: Dashboard 직접 접근 시 인증 리다이렉트', async ({ page }) => {
      albumbuddy = new AlbumBuddyPage(page);
...
test.describe('통합 시나리오', () => {
  ...
  test('AB-NAV-06: 메뉴 탐색 플로우: Shop → About → Pricing', async ({ page }) => {
    albumbuddy = new AlbumBuddyPage(page);
