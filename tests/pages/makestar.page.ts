...
import { MakestarCartPage } from "./makestar-cart.page";
import {
  MAKESTAR_TEXT_PATTERNS,
  type ArtistProfileNavigationResult,
  type MenuItem,
  type WebVitalsResult,
} from "./makestar.types";

export { MAKESTAR_TEXT_PATTERNS } from "./makestar.types";
export type {
  ArtistProfileNavigationResult,
  MenuItem,
  ProductInfo,
  WebVitalsResult,
} from "./makestar.types";
...
export class MakestarPage extends MakestarCartPage {
  // --------------------------------------------------------------------------
  // 로케이터 정의 (멤버 변수)
  // --------------------------------------------------------------------------
