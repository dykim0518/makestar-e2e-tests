/**
 * POCAAlbum 알림 공지 목록 페이지 객체
 *
 * URL: /pocaalbum/notification/notice/list
 */

import { Page, Locator } from "@playwright/test";
import { AdminBasePage, ADMIN_TIMEOUTS } from "./admin-base.page";

export class PocaNotificationListPage extends AdminBasePage {
  ...
  /** 특정 행의 제목 반환 */
  async getNoticeTitle(rowIndex: number): Promise<string> {
